...
#if defined( NE_BUILD_DLL_NE_CORE )
#	define YAML_DECLARE_EXPORT
#else
#	dedine YAML_DECLARE_IMPORT
#endif
...
#define YAML_VERSION_STRING NE_STR(YAML_VERSION_MAJOR) "." NE_STR(YAML_VERSION_MINOR) "." NE_STR(YAML_VERSION_PATCH)
